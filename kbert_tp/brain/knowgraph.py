...
class KnowledgeGraph(object):
    ...
    def _create_lookup_table(self):
        ...
        for i in range(1,51):
            ...
            filename = os.path.join(dir, f'kgs/annotations_pubmed21n00{file_extension}_parsed_triples.spo')
            print("[KnowledgeGraph] Loading spo from local disk")
